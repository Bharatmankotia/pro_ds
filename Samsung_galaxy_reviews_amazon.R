...
aurl<-"https://www.amazon.in/Samsung-Galaxy-M30s-Blue-Storage/product-reviews/B07HGMQX6N/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="
...
# Semantic analysis on samsung galaxy. 
...
pos_words_bar_plot <- function(x){
  ...
  pos_words_freq <- pos_words_freq[order(pos_words_freq$freq,decreasing=T),] # Sorting the words in deceasing order of their frequency
  windows()
...
makewordc(tdm0_2) #  seeing warnings to edit few words
...
makewordc(tdm1_2) #  seeing warnings to edit few words
...
# Number of recommended clusters is 4
...
#  plotting wordclouds for by segment
